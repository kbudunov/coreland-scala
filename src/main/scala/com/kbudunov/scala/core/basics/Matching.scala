...
class Matching {
  ...
  //Compiling your match expression to a tableswitch or lookupswitch is better for
  //performance, because it results in a branch table rather than a decision tree.
  val id = 1
